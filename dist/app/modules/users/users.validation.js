...
const students_constant_1 = require("../students/students.constant");
...
const createUserZodSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        student: zod_1.z.object({
            ...
            gender: zod_1.z.enum([...students_constant_1.gender], {
            ...
            bloodGroup: zod_1.z.enum([...students_constant_1.bloodGroup]).optional(),
            ...
            guardian: zod_1.z.object({
                ...
                address: zod_1.z.string({ required_error: 'Guardian address is required' }),
            }),
